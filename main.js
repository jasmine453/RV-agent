    ...
    try {
        ...
        textDisplay.innerHTML = `
            <div style="padding: 2rem; text-align: center;">
                ...
                <p style="color: #999; font-size: 0.85rem; margin-top: 1rem;">⏱️ 预计需要 4-5 分钟，请耐心等待</p>
            </div>
        `;
    ...
    try {
        ...
        analysisDisplay.innerHTML = `
            <div style="padding: 2rem; text-align: center;">
                ...
                <p style="color: #999; font-size: 0.85rem; margin-top: 1rem;">⏱️ 预计需要 8-10 分钟，请耐心等待</p>
            </div>
        `;
 ...
 */
async function pollTaskStatus(taskId, onProgress = null, maxAttempts = 100, interval = 6000) {
    ...
    for (let attempt = 1; attempt <= maxAttempts; attempt++) {
        try {
            ...
            console.error(`查询任务状态时出错 [${attempt}/${maxAttempts}]:`, error);
