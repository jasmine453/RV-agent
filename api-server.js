        ...
        if (useAsync) {
            ...
            (async () => {
                try {
                    ...
                    // 根据分析类型设置不同的截断长度
                    // 庭外重组协议和预重整方案使用更小的限制，避免Premature close
                    const maxCharsMap = {
                        'outside-agreement': 6000,        // 庭外重组协议
                        'pre-restructure-plan': 6000,     // 预重整方案
                        'restructure-feasibility': 7000,  // 重组可行性报告
                        'enterprise-value': 8000,         // 企业价值评估
                        'value-risk': 8000,               // 价值与风险
                        'risk-indicators': 8000           // 风险指标
                    };
